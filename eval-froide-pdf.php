<?php
// Génération du PDF des évaluations à froid : mise en page partagée par
// l'export complet (export-eval-froide.php) et la notification par mail
// (eval-froide-notification.php), qui n'en tire qu'une seule page.
//
...
/**
 * Construit le document : une réponse par page, dans l'ordre reçu.
 * $compteur affiche « Réponse n / total » en tête de page — utile pour un
 * export groupé, sans objet pour une page isolée.
 */
function ef_pdf_document(array $reponses, bool $compteur = true): EvalFroidePdf
{
    global $EF_QUESTIONS;
